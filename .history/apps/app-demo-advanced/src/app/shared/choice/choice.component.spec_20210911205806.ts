...
describe('ChoiceComponent', () => {
  ...
  it('should only have one radio button checked', () => {
    ...
    const firstRadioButton: HTMLInputElement = radioButtons?.item(0) as HTMLInputElement;
    console.log(Object.prototype.toString.call(firstRadioButton));
    firstRadioButton.click();//?.item(0)?.simulate('click', { target: { checked: true } });
    fixture.detectChanges();
