...
describe('ChoiceComponent', () => {
  ...
  it('should call method onChoiceChange(event: any) when a radio button is checked', waitForAsync (() => {
    const compiled = fixture.debugElement.nativeElement;
    const radioButtons = compiled.querySelectorAll('[data-test^="option"]');
    const spy = jest.spyOn(component, 'onChoiceChange');
    (<HTMLInputElement>radioButtons?.item(0)).click();

    fixture.detectChanges();
    fixture.whenStable().then(() => expect(spy).toBeCalled());
