...
describe('ChoiceComponent', () => {
  ...
  it('should have two radio buttons', () => {
    ...
    const radioButtonsElement: HTMLUListElement = compiled.querySelector('label[data-test="choice-radio-buttons"]');
  ...
  it(`should have the label "${value.label}"`, () => {
    const compiled = fixture.debugElement.nativeElement;
    fixture.detectChanges();
    const asteriskElement = compiled.querySelector('[for="choice"]');
