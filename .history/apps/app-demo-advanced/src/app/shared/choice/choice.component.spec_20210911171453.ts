...
describe('ChoiceComponent', () => {
  ...
  it('should yes and no choice button', () => {
    ...
    const radioElement: DebugElement = compiled.querySelector('[data-test=choice-radio-buttons]');
    // expect(compiled.querySelector('data-choice="choice-radio"').textContent).toContain(
    //   `Welcome to ${title}!`,
    // );
    console.log(JSON.stringify(radioElement));
    console.log(JSON.stringify(fixture.debugElement));
