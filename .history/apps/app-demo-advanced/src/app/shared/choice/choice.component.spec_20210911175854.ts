...
describe('ChoiceComponent', () => {
  ...
  it('should be required and red astericks visible', () => {
    const compiled = fixture.debugElement.nativeElement;
    const astericksElement = compiled.querySelector('[data-test="choice-asteriks"]');

     expect(astericksElement.visible).toBe(true);
  });
