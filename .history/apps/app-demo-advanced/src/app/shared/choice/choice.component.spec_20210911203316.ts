...
describe('ChoiceComponent', () => {
  ...
  it('should have two radio buttons', () => {
    ...
    const radioButtonsElement = compiled.querySelector('input[type="radio"]');
    console.log(JSON.stringify(radioButtonsElement.nativeElement));

    expect(radioButtonsElement.length).toBe(value.choices.length);
  });
