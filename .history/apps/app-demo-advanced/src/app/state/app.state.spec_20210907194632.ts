...
describe('App', () => {
  ...
  it('should travel types', async () => {
    ...
    const app = store.selectSnapshot(state => state.app.travelTypeComponentData);
    console.log(JSON.stringify(app));

    expect(app.travelTypeComponentData.selectedChoice).toBe({"label":"Domestic","value":"Domestic"});
  });
});
