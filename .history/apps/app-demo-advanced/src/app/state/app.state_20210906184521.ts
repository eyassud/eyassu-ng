...
export class AppState {
  ...
  @Action(AppActionTypes.UpdateTextArea)
  UpdateTextArea(ctx: StateContext<AppStateModel>, payload: AppActionTypes.UpdateTextArea) {
    ctx.patchState({
      explanation: payload.textArea.text
    });
  }
